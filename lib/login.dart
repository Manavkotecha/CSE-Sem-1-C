  ...
  Future<void> login() async {
    ...
    if (input.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Enter a valid email or 10-digit mobile number.')),
      );
      return;
    }
    ...
    if (password.isEmpty || !passwordRegEx.hasMatch(password)) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Password must be 6-16 characters long, include at least 1 uppercase letter, and 1 special character.')),
      );
      return;
    }
